...
void AssertsReference::BuildMaterials()
{
	...
	auto GAMEPLAY_ENEMY_STATE_FRONT = std::make_unique<Material>();
	GAMEPLAY_ENEMY_STATE_FRONT->MatCBIndex = TEXTURE_INDEX_UI_GAMEPLAY_ENEMY_STATE_FRONT;
	GAMEPLAY_ENEMY_STATE_FRONT->DiffuseSrvHeapIndex = TEXTURE_INDEX_UI_GAMEPLAY_ENEMY_STATE_FRONT;
	GAMEPLAY_ENEMY_STATE_FRONT->DiffuseAlbedo = XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f);
	GAMEPLAY_ENEMY_STATE_FRONT->FresnelR0 = XMFLOAT3(0.0f, 0.0f, 0.0f);
	GAMEPLAY_ENEMY_STATE_FRONT->Roughness = 0.9;

	auto GAMEPLAY_ENEMY_STATE_BACK = std::make_unique<Material>();
	GAMEPLAY_ENEMY_STATE_BACK->MatCBIndex = TEXTURE_INDEX_UI_GAMEPLAY_ENEMY_STATE_BACK;
	GAMEPLAY_ENEMY_STATE_BACK->DiffuseSrvHeapIndex = TEXTURE_INDEX_UI_GAMEPLAY_ENEMY_STATE_BACK;
	GAMEPLAY_ENEMY_STATE_BACK->DiffuseAlbedo = XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f);
	GAMEPLAY_ENEMY_STATE_BACK->FresnelR0 = XMFLOAT3(0.0f, 0.0f, 0.0f);
	GAMEPLAY_ENEMY_STATE_BACK->Roughness = 0.9;
	...
	m_Materials[TEXTURE_STR_UI_GAMEPLAY_ENEMY_STATE_FRONT] = std::move(GAMEPLAY_ENEMY_STATE_FRONT);
	m_Materials[TEXTURE_STR_UI_GAMEPLAY_ENEMY_STATE_BACK] = std::move(GAMEPLAY_ENEMY_STATE_BACK);

...
{
	// 캐릭터 적용 파티클
	AppContext->CreateParticle(PARTICLE_NAME_SKILL_ON_CHARACTER, CHARACTER_COWBOY, TEXTURE_STR_T_Smoke_Tiled_D, true, XMFLOAT3(0, PLAYER_SIZE_Y, 0), 3.f);
	...
	AppContext->CreateParticle(PARTICLE_NAME_SKILL_ON_CHARACTER, CHARACTER_GUNMAN, TEXTURE_STR_T_Smoke_Tiled_D, true, XMFLOAT3(0, PLAYER_SIZE_Y, 0), 3.f);
	...
	// 기본 파티클
	AppContext->CreateParticle(PARTICLE_NAME_SKILL_ON_CHARACTER, PARTICLE_NAME_SKILL_ON_CHARACTER, TEXTURE_STR_P_SKILL_ON, true, XMFLOAT3(0, 250, 0), 0.5f);
	ParticleSystem::GetApp()->SetParticle(PARTICLE_NAME_SKILL_ON_CHARACTER, PARTICLE_NAME_SKILL_ON_CHARACTER);
}
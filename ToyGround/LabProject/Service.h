...
#define EVENT_GAME_CALLBACK_PUSH_ANIM				0xCB2
#define EVENT_GAME_CALLBACK_POP_ANIM				0xCB3
#define EVENT_GAME_REQUEST_PUSH_ANIM				0xCB4
#define EVENT_GAME_REQUEST_POP_ANIM					0xCB5

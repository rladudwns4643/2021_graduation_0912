...
#define EVENT_LOBBY_LOGIN_REQUEST					0xA0
#define EVENT_LOBBY_LOGIN_OK						0xA1
#define EVENT_LOBBY_LOGIN_FAIL						0xA2
#define EVENT_LOBBY_SIGNUP_OK						0xA3
#define EVENT_LOBBY_SIGNUP_FAIL						0xA4
#define EVENT_LOBBY_UPDATE_CLIENT_USERINFO			0xA5
#define EVENT_LOBBY_MATCH_START						0xA6
#define EVENT_LOBBY_MATCH_CANCEL					0xA7

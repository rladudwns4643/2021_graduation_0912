...
#define EVENT_GAME_CALLBACK_MOVE					0xC0
#define EVENT_GAME_MAKE_MOVE						0xC1
#define EVENT_GAME_CALLBACK_MOUSE					0xC2
#define EVENT_GAME_MAKE_MOUSE						0xC3
#define EVENT_GAME_SHOOT_BULLET						0xC4
#define EVENT_GAME_REMOVE_BULLET					0xC5
#define EVENT_GAME_HIT								0xC6
#define EVENT_GAME_DIE								0xC7
#define EVENT_GAME_ANIM								0xC8

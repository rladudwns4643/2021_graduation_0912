...
public:
	enum PlayerState
	{
		...
		STATE_DEATH,
		STATE_DEATH_TO_IDLE,
		STATE_DEATH_TO_FORWARD,
		STATE_DEATH_TO_BACKWARD,
		STATE_DEATH_TO_LEFT_STRAFE,
		STATE_DEATH_TO_RIGHT_STRAFE,
		STATE_DEATH_TO_ATTACK,
		STATE_DEATH_TO_JUMP,
	};

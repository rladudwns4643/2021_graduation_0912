...
public:
	...
	void UpdateInstanceData(ObjectInfo* objInfo, std::vector<GameObject*>& rItems, bool isCharacter = false, bool isParticle = false);
	void UpdateGemInstanceData(ObjectInfo* objInfo, std::vector<GameObject*>& rItems);
